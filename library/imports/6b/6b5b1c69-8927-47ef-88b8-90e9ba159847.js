...
cc.Class({
    ...
    hasConsecutive: function hasConsecutive(arr, amount) {
        console.log("blue water hasConsecutive" + Global.arrayfood);
        ...
        while (u == 0) {
            if (Global.firstnode != null && Global.secondnode == null && Global.last == "Blue") {
                ...
                console.log("If secondnode empty put blue here ver 2");
                break;
                ...
                break;
            } else if (Global.last == "Blue") {
                // if (Global.firstnode != null && Global.secondnode == null) {
                //     Global.secondnode = currentNode;
                //     Global.arrayNode.push(currentNode);
                //     console.log("second node: " + Global.secondnode);
                //     console.log("last: " + Global.last)
                //     console.log("If secondnode empty put blue here")
                //     cc.audioEngine.playEffect(this.scoreAudio, false);
                //     break
                // } 
                if (Global.firstnode != null && Global.secondnode != null) {
                    if (Global.last == "Blue") {
                        ...
                        Global.arrayNode.push(currentNode);
                        Global.last = "Blue";
                        console.log("If first and second filled put third blue here");
